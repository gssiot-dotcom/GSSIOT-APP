...
export default function VerticalGraphScreen() {
  ...
  const fetchGraphData = useCallback(async (isRefresh = false) => {
    try {
      ...
      console.log("vertical graph result:", historyList);
      ...
      console.log("vertical graph error status:", error?.response?.status);
      console.log("vertical graph error data:", error?.response?.data);
      console.log("vertical graph error message:", error?.message);
  ...
  useRealtimeRoom({
    ...
    onMessage: (payload: any) => {
      console.log("vertical graph realtime:", payload);
